    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans relative overflow-hidden">
            ...
            <main className="container mx-auto px-4 py-16 max-w-6xl mt-6 relative z-10">
                ...
                >
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-8 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600 font-serif max-w-4xl">
                        About HackathonHub
                    </h1>
                    <p className="text-xl mb-8 text-gray-300 font-light leading-relaxed max-w-3xl">
                ...
                >
                    <motion.div
                        className="bg-white bg-opacity-10 p-8 rounded-lg shadow-xl hover:bg-opacity-20 transition-all duration-300"
                ...
                >
                    <motion.div
                        className="bg-white bg-opacity-10 p-8 rounded-lg shadow-xl hover:bg-opacity-20 transition-all duration-300 order-1 md:order-2"
                        whileHover={{ scale: 1.05 }}
                    >
                ...
                <motion.div
                    ...
                    className="mb-16"
                >
                    <h2 className="text-3xl font-semibold mb-8 text-center text-blue-400">What Sets Us Apart</h2>
                ...
                >
                    <h2 className="text-3xl font-semibold mb-8 text-purple-400">Join Our Community</h2>
                    <p className="text-xl mb-8 text-gray-300 font-light">
                        Ready to embark on your next hackathon adventure? Join HackathonHub today and be part of a thriving community of innovators!
                    </p>
                    <Button onClick={() => router.push('/hackathons')} size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white transition-all duration-300 transform hover:scale-105 text-lg px-8 py-3">
                        Get Started
                    </Button>
                </motion.div>
            </main>
